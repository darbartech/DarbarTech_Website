...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex min-h-screen overflow-x-hidden bg-(--bg-primary-dashboard)">
      {/* Sidebar */}
      <AdminNavbar />
      ...
      <main className="min-w-0 flex-1 p-3 sm:p-5 lg:p-6">
        ...
        <div className="flex min-h-12 items-center justify-between gap-4 border-b border-(--border-primary-dashboard) pb-3 sm:pb-4">
          {/* Page Navigation */}
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            <button
              type="button"
              aria-label="Search"
              className="rounded-lg p-2 text-(--text-primary-dashboard) transition hover:bg-(--secondary-bg-dashboard) hover:text-(--bg-dashboard-hero)"
            >
        ...
        <section className="relative mt-5 overflow-hidden rounded-xl bg-(--bg-dashboard-hero)">
          <div className="relative z-10 flex min-h-64 items-center px-5 py-8 sm:min-h-72 sm:px-8 sm:py-10 lg:min-h-80 lg:px-12">
