...
const Footer = () => {
  return (
    <div className="px-30 pt-10 pb-5 text-sm font-bold bg-(--bg-footer) text-(--primary-bg-color) flex flex-col space-y-5">
      ...
      {/* terms & condition div */}
      <div className="border-t border-(--bg-muted) pt-5 flex items-center justify-between font-semibold">
        <div>
          <p>
            &copy; Karlson is prouldy owned by{" "}
            <span className="text-(--secondary-bg-color)">EnvyTheme</span>
          </p>
        </div>
        <div>
